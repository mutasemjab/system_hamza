                ...
                <div class="field">
                    ...
                    <div class="field-wrap">
                        ...
                        <input type="text"
                               ...
                               class="<?php echo e($errors->has('username') ? 'is-error' : ''); ?>"
                               autofocus>
                    </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="login-footer">
                &copy; <?php echo e(date('Y')); ?> <strong>Sys Academy</strong>. جميع الحقوق محفوظة.
            </div>
...
<?php /**PATH C:\xampp\htdocs\sys\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>