...
@section('title', 'توليد الجدول')

@section('contentheader', 'توليد جدول المحتوى')
@section('contentheaderactive', 'الجدول الزمني')
    ...
    <div class="col-lg-7 mb-4">
        <div class="card">
            <div class="card-header">
                ...
                <span class="card-title">توليد جدول شهري</span>
            </div>
            <div class="card-body">
        ...
        <div class="card">
            ...
            <div class="card-body" style="font-size:13.5px;color:var(--text-muted);line-height:2">
                ...
                <div style="margin-top:14px;padding:12px;background:#f0fdf4;border-radius:8px;border:1px solid #bbf7d0;color:#15803d;font-size:12.5px">
                    ...
                    مثال: أحمد، محمد، حسين ← كل اثنين وخميس من اليوم لمدة شهر → جلسة 1: أحمد، جلسة 2: محمد، جلسة 3: حسين، جلسة 4: أحمد...
                </div>
            </div>
        </div>
    </div>
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <div>
            ...
            <span class="badge badge-secondary ml-2">{{ $scheduled->count() }}</span>
        </div>
    </div>
    @if($scheduled->count())
        ...
        <div class="table-responsive">
            <table class="table mb-0">
                ...
                <tbody>
                    ...
                    @php $isPast = $item->scheduled_date && $item->scheduled_date->isPast() && $item->status !== 'published'; @endphp
                    <tr class="{{ $isPast ? 'past-row' : '' }}">
                        ...
                        <td>
                            @if($item->status === 'published')
                                <span class="badge badge-success"><i class="fas fa-check mr-1"></i> تم النشر</span>
                            @elseif($isPast)
...
/* Select2 for players (ordered, keep selection order) */
jQuery(function($) {
...
function updatePreview() {
    ...
    const players  = Array.from(document.getElementById('playerSelect').selectedOptions).length;
